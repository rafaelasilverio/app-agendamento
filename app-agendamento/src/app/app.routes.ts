...
export const routes: Routes = [
  ...
  { path: 'register-service', loadComponent: () => import('./pages/tela-usuario/components/tela-cadastrar-servico/tela-cadastrar-servico.component').then(m => m.TelaCadastrarServicoComponent) },
  ...
  { path: 'edit-services/:id', loadComponent: () => import('./pages/tela-usuario/components/tela-editar-servico/tela-editar-servico.component').then(m => m.TelaEditarServicoComponent) },
